...
namespace FornecedoresDDD.Apresentacao.MVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IProduto, ProdutoRepositorio>();
        }
